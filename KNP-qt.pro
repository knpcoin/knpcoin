...
isEmpty(BDB_LIB_PATH) {
    macx:BDB_LIB_PATH = /usr/local/BerkeleyDB.18.1/lib
}

isEmpty(BDB_LIB_SUFFIX) {
    macx:BDB_LIB_SUFFIX = -18
}

isEmpty(BDB_INCLUDE_PATH) {
    macx:BDB_INCLUDE_PATH = /usr/local/BerkeleyDB.18.1/include
}
...
macx:ICON = src/qt/res/icons/knp.icns
macx:TARGET = "KNP-Qt"
...
# -lgdi32 -pthread has to happen after -lcrypto (see  #681)
